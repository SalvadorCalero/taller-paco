                            ...
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                        ...
                                        >
                                            ...
                                            <div className="pt-3 sm:pt-5 lg:pt-0">
                                                ...
                                                <p className="mt-4 text-sm/relaxed">
                                                    Laravel cuenta con una
                                                    excelente documentación que
                                                    cubre todos los aspectos del
                                                    framework. Tanto si eres
                                                    nuevo en Laravel como si ya
                                                    tienes experiencia, te
                                                    recomendamos leer nuestra
                                                    documentación de principio a
                                                    fin.
                                                </p>
                                            </div>
                                        </div>
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Laracasts ofrece miles de
                                            videotutoriales sobre Laravel, PHP y
                                            desarrollo con JavaScript. Échales
                                            un vistazo, compruébalo tú mismo y
                                            mejora enormemente tus habilidades
