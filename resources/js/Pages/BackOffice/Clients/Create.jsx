...
export default function Create({ auth }) {
    // Inicializamos el estado del formulario asegurando que las claves
    // coinciden exactamente con los nombres de las columnas en la tabla 'clients'
    ...
    // Interceptamos el evento submit por defecto del navegador
    const submit = (e) => {
        e.preventDefault();
        // post() envía los datos al controlador y gestiona los errores automáticamente
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            required
                                            maxLength="20"
                                            pattern="(?:\+34|0034)?[6789]\d{8}" /* <-- REGLA AÑADIDA AQUÍ */
                                            title="Introduce un teléfono fijo o móvil válido de 9 dígitos (ej: 600123456)" /* <-- MENSAJE AÑADIDO AQUÍ */
                                            className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                        />
