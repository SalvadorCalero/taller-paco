                            ...
                            {vehicles.length === 0 ? (
                                ...
                                <div className="text-center py-10 bg-gray-50 rounded border border-dashed border-gray-300">
                                    ...
                                    <p className="text-gray-500 italic">
                                        No hay ningún vehículo registrado a
                                                ...
                                                >
                                                    ...
                                                    <td className="px-4 py-3">
                                                        ...
                                                        <Link
                                                            ...
                                                            className="text-green-600 hover:text-green-800 hover:underline text-xs font-bold transition"
                                                        >
                                                            + Nueva Orden
                                                        </Link>
                                                    </td>
