...
export default function Index({ auth, clients }) {
    ...
    const handleDelete = (id) => {
        if (
            confirm(
                "¿Estás seguro de que deseas eliminar este cliente? Se borrarán también sus vehículos y reparaciones asociadas.",
            )
        ) {
                                    ...
                                    <tbody>
                                        {clients.data.map((client) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4">
                                                    {/* El botón "Ver Ficha" será crucial más adelante para ver sus coches */}
                                                    <Link
                                                        href={route(
                                                            "admin.clients.show",
                                                            client.id,
